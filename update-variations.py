...
def usage ():
    ...
    print ("color can be 'Aqua', 'Blue', 'Grey', 'Orange', 'Pink', 'Purple', 'Red', 'Sand', 'Teal', 'Gecko' or 'All'.")
    sys.exit(1)
...
if len(sys.argv) < 2:
    ...
    if not color_variation in ["Aqua", "Blue", "Grey", "Orange", "Pink", "Purple", "Red", "Sand", "Teal", "Gecko", "All"]:
        usage()
